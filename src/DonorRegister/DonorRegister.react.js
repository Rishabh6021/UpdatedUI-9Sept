...
let url="http://localhost:3210/donorList";
                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div className="form-group row">
                                            <label for="donor_availablity" class="col-sm-5 col-form-label"><h5>Donor Status</h5></label>
                                            <div class="col-sm-12">
                                        
                                            <input id="donor_status" name="donor_availablity"  type="radio"onChange={this.handleChange} defaultChecked/>Available &nbsp;&nbsp;
