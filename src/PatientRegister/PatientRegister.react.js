...
class PatientRegister extends React.Component {
    ...
    render() {
            ...
            <div class="col-sm-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="col-sm-12">
                  <input type="text" className="form-control" name="patientName"  onChange={this.handleChange} required/>
                  </div>
                  </div>
                  ...
                  <div class="col-sm-12">
                  <select class="form-control" id="id" name="bloodGroup" onChange={this.handleChange1}>
                                <option>O+ve</option>
                                <option>O-ve</option>
                                <option>A+ve</option>
                                <option>A-ve</option>
        ...
        <div className="form-group row">
                  ...
                  <div class="col-sm-12">
                  <input type="number" name='phoneNumber' className="form-control"  onChange={this.handleChange} required/>
                  </div>
        </div>
        ...
        <div className="form-group row">
                  ...
                  <div class="col-sm-12">
                  <input type="number" name='text' className="form-control"  onChange={this.handleChange} required/>
                  </div>
        </div>
